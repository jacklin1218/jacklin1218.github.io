...
function sceneDesign() {
  ...
  scene.obstacles = [];
  scene.obstacles.push(new Obstacle(new THREE.Vector3(50, 0, 50), 50))
  scene.obstacles.push(new Obstacle(new THREE.Vector3(-180, 0, 200), 30))
  scene.obstacles.push(new Obstacle(new THREE.Vector3(0, 0, -300), 60))
  scene.obstacles.push(new Obstacle(new THREE.Vector3(100, 0, -300), 60))
  scene.obstacles.push(new Obstacle(new THREE.Vector3(30, 0, 100), 40))
  scene.obstacles.push(new Obstacle(new THREE.Vector3(200, 0, -10), 60))
  scene.obstacles.push(new Obstacle(new THREE.Vector3(150, 0, 150), 60))
    
  scene.targets = [];
  scene.targets.push(new Target(1, new THREE.Vector3(300, 0, 300)));
  scene.targets.push(new Target(2, new THREE.Vector3(-100, 0, 150)));
  scene.targets.push(new Target(3, new THREE.Vector3(250, 0, -200)));
  scene.targets.push(new Target(4, new THREE.Vector3(-50, 0, -100)));
